...
geom_folder_path = "/afs/ipp-garching.mpg.de/home/k/kristiantcho/ptmp/nugget/nugget/examples/rov_uniform_geom_iter_0"
...
for _ in range(14):
    ...
    geom_dict = optimizer.optimize(
        ...
        n_iter=100,                           # Maximum number of optimization iterations
