...
# llr_net.save_model('best_ls_signal_only_model_large_uniform_logE_poisson_cylinder')

# #save history as pickle
# pickle.dump(history, open('signal_only_uniform_logE_poisson_cylinder_training_history.pkl', 'wb'))